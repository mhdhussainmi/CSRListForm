...
function AddResourcesToHeader() {
    try {
        var boostrapCssUrl = _spPageContextInfo.webAbsoluteUrl + "/SiteAssets/CSS/bootstrap.min.css";
        var boostrapGridCssUrl = _spPageContextInfo.webAbsoluteUrl + "/SiteAssets/CSS/bootstrap-grid.min.css";
        var customCssUrl = _spPageContextInfo.webAbsoluteUrl + "/SiteAssets/CSS/csr.sharepoint.list.forms.css";
        var boostrapJsUrl = _spPageContextInfo.webAbsoluteUrl + "/SiteAssets/Artefacts/bootstrap.min.js";
...
function GenerateView(ctx) {
    try {
        ...
        if (footerArray.length > 0) {
            ...
            var footerRowTemplate = "<div class='card-group'><div class='col-md-4 card' style='background-color:rgba(0,0,0,.125)'><div><h6 class='card-title'>{0}:</h6></div></div><div class='col-md-8'><div>{1}</div></div></div>";
            ...
            formTable += "<div class='h-divider'></div>";
            //Save Button
            formTable += "<div class='col-md-12 card-group'><div class='col-md-6'>" + msFormToolBarHtml + "</div><div class='col-md-6'><a href='javascript:void(0);' id='linkVersionHistory' onclick='javascript:ShowDialog()' class='btnCsrGeneric' style='float:right'/>View Version History</a></div></div>";
            formTable += "</div>";
